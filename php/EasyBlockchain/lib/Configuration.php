...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://gw.api.cloud.sphereon.com/blockchain/easy/0.10';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/0.10.3-SNAPSHOT/php';
    ...
    {
        $report  = 'PHP SDK (Sphereon\SDK\Blockchain\Easy) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 0.10' . PHP_EOL;
        $report .= '    SDK Package Version: 0.10.3-SNAPSHOT' . PHP_EOL;
