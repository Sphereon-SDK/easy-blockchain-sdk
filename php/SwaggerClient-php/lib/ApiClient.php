...
class ApiClient
{
     ...
     */
    public function __construct(\Sphereon\SDK\Blockchain\Easy\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Sphereon\SDK\Blockchain\Easy\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Sphereon\SDK\Blockchain\Easy\ObjectSerializer::sanitizeForSerialization($postData));
        }
