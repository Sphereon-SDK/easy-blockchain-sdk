...
import com.sphereon.sdk.blockchain.easy.handler.auth.Authentication;
import com.sphereon.sdk.blockchain.easy.handler.auth.HttpBasicAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://gw-dev.api.cloud.sphereon.com/blockchain/easy/0.10";
  ...
  public ApiClient() {
    ...
    setUserAgent("Swagger-Codegen/0.10/java");
