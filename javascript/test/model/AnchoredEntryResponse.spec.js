...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyBlockchainApi.AnchoredEntryResponse();
  });
  ...
  describe('AnchoredEntryResponse', function() {
    it('should create an instance of AnchoredEntryResponse', function() {
      // uncomment below and update the code to test AnchoredEntryResponse
      //var instane = new EasyBlockchainApi.AnchoredEntryResponse();
      //expect(instance).to.be.a(EasyBlockchainApi.AnchoredEntryResponse);
    });

    it('should have the property anchoredEntry (base name: "anchoredEntry")', function() {
      // uncomment below and update the code to test the property anchoredEntry
      //var instane = new EasyBlockchainApi.AnchoredEntryResponse();
      //expect(instance).to.be();
    });

    it('should have the property anchorTimes (base name: "anchorTimes")', function() {
      // uncomment below and update the code to test the property anchorTimes
      //var instane = new EasyBlockchainApi.AnchoredEntryResponse();
      //expect(instance).to.be();
    });
