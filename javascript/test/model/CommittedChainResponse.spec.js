...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyBlockchainApi.CommittedChainResponse();
  });
  ...
  describe('CommittedChainResponse', function() {
    it('should create an instance of CommittedChainResponse', function() {
      // uncomment below and update the code to test CommittedChainResponse
      //var instane = new EasyBlockchainApi.CommittedChainResponse();
      //expect(instance).to.be.a(EasyBlockchainApi.CommittedChainResponse);
    });
