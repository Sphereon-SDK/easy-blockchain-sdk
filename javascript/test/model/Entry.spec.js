...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyBlockchainApi.Entry();
  });
  ...
  describe('Entry', function() {
    it('should create an instance of Entry', function() {
      ...
      //expect(instance).to.be.a(EasyBlockchainApi.Entry);
    });

    it('should have the property entryData (base name: "entryData")', function() {
      // uncomment below and update the code to test the property entryData
      //var instane = new EasyBlockchainApi.Entry();
