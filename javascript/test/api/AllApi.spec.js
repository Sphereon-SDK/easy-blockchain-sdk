...
(function(root, factory) {
  ...
  describe('AllApi', function() {
    describe('createChainUsingPOST', function() {
      it('should call createChainUsingPOST successfully', function(done) {
        //uncomment below and update the code to test createChainUsingPOST
        //instance.createChainUsingPOST(pet, function(error) {
    ...
    describe('createEntryUsingPOST', function() {
      it('should call createEntryUsingPOST successfully', function(done) {
        //uncomment below and update the code to test createEntryUsingPOST
        //instance.createEntryUsingPOST(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('determineChainId', function() {
      it('should call determineChainId successfully', function(done) {
        ...
        //instance.determineChainId(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('determineEntryId', function() {
      it('should call determineEntryId successfully', function(done) {
        ...
        //instance.determineEntryId(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
