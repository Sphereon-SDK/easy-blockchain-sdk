...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['EasyBlockchain/ApiClient', 'EasyBlockchain/model/Backend', 'EasyBlockchain/model/ErrorResponse', 'EasyBlockchain/model/Context'], factory);
  ...
  /**
   * Context service.
   * @module EasyBlockchain/api/ContextApi
   * @version 0.9
   */

  /**
   * Constructs a new ContextApi. 
   * @alias module:EasyBlockchain/api/ContextApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:EasyBlockchain/api/ContextApi~createBackendCallback
     ...
     * @param {module:EasyBlockchain/api/ContextApi~createBackendCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EasyBlockchain/api/ContextApi~createContextCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EasyBlockchain/api/ContextApi~createContextCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EasyBlockchain/api/ContextApi~deleteBackendCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EasyBlockchain/api/ContextApi~deleteBackendCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EasyBlockchain/api/ContextApi~findBackendsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EasyBlockchain/api/ContextApi~findBackendsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EasyBlockchain/api/ContextApi~getBackendCallback
     * @param {String} error Error message, if any.
     * @param {module:EasyBlockchain/model/Backend} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.includePublic includePublic (default to false)
     * @param {module:EasyBlockchain/api/ContextApi~getBackendCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:EasyBlockchain/model/Backend}
     */
     ...
     * @callback module:EasyBlockchain/api/ContextApi~getContextCallback
     * @param {String} error Error message, if any.
     * @param {module:EasyBlockchain/model/Context} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:EasyBlockchain/api/ContextApi~getContextCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:EasyBlockchain/model/Context}
     */
     ...
     * @callback module:EasyBlockchain/api/ContextApi~listBackendsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:EasyBlockchain/model/Backend>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:EasyBlockchain/api/ContextApi~listBackendsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:EasyBlockchain/model/Backend>}
     */
