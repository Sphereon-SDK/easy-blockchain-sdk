...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['EasyBlockchain/ApiClient', 'EasyBlockchain/model/Access', 'EasyBlockchain/model/RpcProvider'], factory);
   ...
   * @module EasyBlockchain/model/Backend
   * @version 0.9
   */
   ...
   * Backend
   * @alias module:EasyBlockchain/model/Backend
   * @class
   */
   ...
   * @param {module:EasyBlockchain/model/Backend} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/Backend} The populated <code>Backend</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('apiVersion')) {
        obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'Integer');
      }
  ...
  /**
   * @member {Array.<module:EasyBlockchain/model/RpcProvider>} rpcProviders
   */
  exports.prototype['rpcProviders'] = undefined;
  /**
   * @member {Integer} apiVersion
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/Backend.ImplementationEnum} implementation
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/Backend.DataStructureEnum} dataStructure
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/Access} externalAccess
   */
