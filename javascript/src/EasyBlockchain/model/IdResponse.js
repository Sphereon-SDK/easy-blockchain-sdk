...
(function(root, factory) {
   ...
   * @module EasyBlockchain/model/IdResponse
   * @version 0.9
   */
   ...
   * Id response
   * @alias module:EasyBlockchain/model/IdResponse
   * @class
   * @param exists {module:EasyBlockchain/model/IdResponse.ExistsEnum} 
   */
   ...
   * @param {module:EasyBlockchain/model/IdResponse} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/IdResponse} The populated <code>IdResponse</code> instance.
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/IdResponse.ExistsEnum} exists
   */
