...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['EasyBlockchain/ApiClient', 'EasyBlockchain/model/ExternalId'], factory);
   ...
   * @module EasyBlockchain/model/EntryData
   * @version 0.9
   */
   ...
   * Entry Data
   * @alias module:EasyBlockchain/model/EntryData
   * @class
   ...
   * @param {module:EasyBlockchain/model/EntryData} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/EntryData} The populated <code>EntryData</code> instance.
   */
  ...
  /**
   * External IDs
   * @member {Array.<module:EasyBlockchain/model/ExternalId>} externalIds
   */
