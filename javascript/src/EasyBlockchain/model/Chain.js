...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['EasyBlockchain/ApiClient', 'EasyBlockchain/model/Entry'], factory);
   ...
   * @module EasyBlockchain/model/Chain
   * @version 0.9
   */
   ...
   * Chain
   * @alias module:EasyBlockchain/model/Chain
   * @class
   * @param firstEntry {module:EasyBlockchain/model/Entry} 
   */
   ...
   * @param {module:EasyBlockchain/model/Chain} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/Chain} The populated <code>Chain</code> instance.
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/Entry} firstEntry
   */
