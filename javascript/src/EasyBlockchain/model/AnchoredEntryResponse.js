...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['EasyBlockchain/ApiClient', 'EasyBlockchain/model/CommittedEntry'], factory);
   ...
   * @module EasyBlockchain/model/AnchoredEntryResponse
   * @version 0.9
   */
   ...
   * @alias module:EasyBlockchain/model/AnchoredEntryResponse
   * @class
   * @param anchoredEntry {module:EasyBlockchain/model/CommittedEntry} 
   * @param anchorState {module:EasyBlockchain/model/AnchoredEntryResponse.AnchorStateEnum} 
   */
   ...
   * @param {module:EasyBlockchain/model/AnchoredEntryResponse} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/AnchoredEntryResponse} The populated <code>AnchoredEntryResponse</code> instance.
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/CommittedEntry} anchoredEntry
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/AnchoredEntryResponse.AnchorStateEnum} anchorState
   */
