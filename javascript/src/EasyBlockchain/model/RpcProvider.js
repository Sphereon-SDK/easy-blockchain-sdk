...
(function(root, factory) {
   ...
   * @module EasyBlockchain/model/RpcProvider
   * @version 0.9
   */
   ...
   * RpcProvider
   * @alias module:EasyBlockchain/model/RpcProvider
   * @class
   */
   ...
   * @param {module:EasyBlockchain/model/RpcProvider} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/RpcProvider} The populated <code>RpcProvider</code> instance.
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/RpcProvider.OwnerTypeEnum} ownerType
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/RpcProvider.TypeEnum} type
   */
