...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyBlockchainApi.Access = factory(root.EasyBlockchainApi.ApiClient);
  }
   ...
   * @module EasyBlockchain/model/Access
   * @version 0.9
   */

  /**
   * Constructs a new <code>Access</code>.
   * @alias module:EasyBlockchain/model/Access
   * @class
   */
   ...
   * @param {module:EasyBlockchain/model/Access} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/Access} The populated <code>Access</code> instance.
   */
  ...
  /**
   * @member {Array.<module:EasyBlockchain/model/Access.ModesEnum>} modes
   */
