...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['EasyBlockchain/ApiClient', 'EasyBlockchain/model/CommittedChain'], factory);
   ...
   * @module EasyBlockchain/model/CommittedChainResponse
   * @version 0.9
   */
   ...
   * @alias module:EasyBlockchain/model/CommittedChainResponse
   * @class
   * @param chain {module:EasyBlockchain/model/CommittedChain} 
   */
   ...
   * @param {module:EasyBlockchain/model/CommittedChainResponse} obj Optional instance to populate.
   * @return {module:EasyBlockchain/model/CommittedChainResponse} The populated <code>CommittedChainResponse</code> instance.
   */
  ...
  /**
   * @member {module:EasyBlockchain/model/CommittedChain} chain
   */
