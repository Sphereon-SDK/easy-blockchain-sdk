...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBlockchainEasy/ApiClient', 'SphereonSDKBlockchainEasy/model/VndError'], factory);
    ...
    root.EasyBlockchainApi.VndErrors = factory(root.EasyBlockchainApi.ApiClient, root.EasyBlockchainApi.VndError);
  }
   ...
   * @module SphereonSDKBlockchainEasy/model/VndErrors
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>VndErrors</code>.
   * @alias module:SphereonSDKBlockchainEasy/model/VndErrors
   * @class
   */
   ...
   * @param {module:SphereonSDKBlockchainEasy/model/VndErrors} obj Optional instance to populate.
   * @return {module:SphereonSDKBlockchainEasy/model/VndErrors} The populated <code>VndErrors</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('error')) {
        obj['error'] = ApiClient.convertToType(data['error'], [VndError]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:SphereonSDKBlockchainEasy/model/VndError>} error
   */
