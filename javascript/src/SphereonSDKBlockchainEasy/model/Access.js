...
(function(root, factory) {
   ...
   * @module SphereonSDKBlockchainEasy/model/Access
   * @version 0.9.1
   */

  /**
   * Constructs a new <code>Access</code>.
   * @alias module:SphereonSDKBlockchainEasy/model/Access
   * @class
   */
   ...
   * @param {module:SphereonSDKBlockchainEasy/model/Access} obj Optional instance to populate.
   * @return {module:SphereonSDKBlockchainEasy/model/Access} The populated <code>Access</code> instance.
   */
