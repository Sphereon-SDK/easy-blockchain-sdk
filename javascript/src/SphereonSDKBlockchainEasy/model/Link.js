...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyBlockchainApi.Link = factory(root.EasyBlockchainApi.ApiClient);
  }
   ...
   * @module SphereonSDKBlockchainEasy/model/Link
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>Link</code>.
   * @alias module:SphereonSDKBlockchainEasy/model/Link
   * @class
   */
   ...
   * @param {module:SphereonSDKBlockchainEasy/model/Link} obj Optional instance to populate.
   * @return {module:SphereonSDKBlockchainEasy/model/Link} The populated <code>Link</code> instance.
   */
