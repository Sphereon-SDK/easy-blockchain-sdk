...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBlockchainEasy/ApiClient', 'SphereonSDKBlockchainEasy/model/CommittedEntryResponse', 'SphereonSDKBlockchainEasy/model/Entry', 'SphereonSDKBlockchainEasy/model/VndErrors', 'SphereonSDKBlockchainEasy/model/IdResponse', 'SphereonSDKBlockchainEasy/model/AnchoredEntryResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CommittedEntryResponse'), require('../model/Entry'), require('../model/VndErrors'), require('../model/IdResponse'), require('../model/AnchoredEntryResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.EasyBlockchainApi) {
      root.EasyBlockchainApi = {};
    }
    root.EasyBlockchainApi.EntryDataApi = factory(root.EasyBlockchainApi.ApiClient, root.EasyBlockchainApi.CommittedEntryResponse, root.EasyBlockchainApi.Entry, root.EasyBlockchainApi.VndErrors, root.EasyBlockchainApi.IdResponse, root.EasyBlockchainApi.AnchoredEntryResponse);
  }
}(this, function(ApiClient, CommittedEntryResponse, Entry, VndErrors, IdResponse, AnchoredEntryResponse) {
  'use strict';

  /**
   * EntryData service.
   * @module SphereonSDKBlockchainEasy/api/EntryDataApi
   * @version 0.1.0
   */

  /**
   * Constructs a new EntryDataApi. 
   * @alias module:SphereonSDKBlockchainEasy/api/EntryDataApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:SphereonSDKBlockchainEasy/api/EntryDataApi~determineEntryIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:SphereonSDKBlockchainEasy/api/EntryDataApi~determineEntryIdCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:SphereonSDKBlockchainEasy/api/EntryDataApi~entryByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:SphereonSDKBlockchainEasy/api/EntryDataApi~entryByIdCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:SphereonSDKBlockchainEasy/api/EntryDataApi~entryByRequestCallback
     * @param {String} error Error message, if any.
     * @param {module:SphereonSDKBlockchainEasy/model/AnchoredEntryResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:SphereonSDKBlockchainEasy/api/EntryDataApi~entryByRequestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:SphereonSDKBlockchainEasy/model/AnchoredEntryResponse}
     */
