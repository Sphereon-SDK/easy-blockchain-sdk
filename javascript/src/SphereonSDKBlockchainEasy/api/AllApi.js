...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBlockchainEasy/ApiClient', 'SphereonSDKBlockchainEasy/model/CommittedChainResponse', 'SphereonSDKBlockchainEasy/model/Chain', 'SphereonSDKBlockchainEasy/model/VndErrors', 'SphereonSDKBlockchainEasy/model/CommittedEntryResponse', 'SphereonSDKBlockchainEasy/model/Entry', 'SphereonSDKBlockchainEasy/model/IdResponse', 'SphereonSDKBlockchainEasy/model/AnchoredEntryResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CommittedChainResponse'), require('../model/Chain'), require('../model/VndErrors'), require('../model/CommittedEntryResponse'), require('../model/Entry'), require('../model/IdResponse'), require('../model/AnchoredEntryResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.EasyBlockchainApi) {
      root.EasyBlockchainApi = {};
    }
    root.EasyBlockchainApi.AllApi = factory(root.EasyBlockchainApi.ApiClient, root.EasyBlockchainApi.CommittedChainResponse, root.EasyBlockchainApi.Chain, root.EasyBlockchainApi.VndErrors, root.EasyBlockchainApi.CommittedEntryResponse, root.EasyBlockchainApi.Entry, root.EasyBlockchainApi.IdResponse, root.EasyBlockchainApi.AnchoredEntryResponse);
  }
}(this, function(ApiClient, CommittedChainResponse, Chain, VndErrors, CommittedEntryResponse, Entry, IdResponse, AnchoredEntryResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:SphereonSDKBlockchainEasy/api/AllApi~createChainUsingPOSTCallback
     ...
     * @param {module:SphereonSDKBlockchainEasy/api/AllApi~createChainUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:SphereonSDKBlockchainEasy/api/AllApi~createEntryUsingPOSTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:SphereonSDKBlockchainEasy/api/AllApi~createEntryUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * data is of type: {@link module:SphereonSDKBlockchainEasy/model/IdResponse}
     */
    this.determineEntryId = function(chainId, entry, callback) {
      var postBody = entry;
