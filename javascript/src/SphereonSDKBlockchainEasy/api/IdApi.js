...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBlockchainEasy/ApiClient', 'SphereonSDKBlockchainEasy/model/Chain', 'SphereonSDKBlockchainEasy/model/IdResponse', 'SphereonSDKBlockchainEasy/model/VndErrors', 'SphereonSDKBlockchainEasy/model/Entry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Chain'), require('../model/IdResponse'), require('../model/VndErrors'), require('../model/Entry'));
  } else {
    // Browser globals (root is window)
    if (!root.EasyBlockchainApi) {
      root.EasyBlockchainApi = {};
    }
    root.EasyBlockchainApi.IdApi = factory(root.EasyBlockchainApi.ApiClient, root.EasyBlockchainApi.Chain, root.EasyBlockchainApi.IdResponse, root.EasyBlockchainApi.VndErrors, root.EasyBlockchainApi.Entry);
  }
}(this, function(ApiClient, Chain, IdResponse, VndErrors, Entry) {
  'use strict';
