...
public class CommittedEntry {
  ...
  private List<RawBackendStructure> rawBackendStructures = null;
  ...
  **/
  ...
  public CommittedEntry addRawBackendStructuresItem(RawBackendStructure rawBackendStructuresItem) {
    if (this.rawBackendStructures == null) {
      this.rawBackendStructures = new ArrayList<RawBackendStructure>();
    }
  ...
  **/
  @ApiModelProperty(value = "Raw data structures of backend")
