...
- API version: 0.9.1
- SDK version: 1.0.0
- Build date: 2017-05-04T09:10:28.237-03:00
...
*AllApi* | [**GetContext**](docs/AllApi.md#getcontext) | **GET** /blockchain/easy/0.9.1/{context} | Create a new context
...
*ContextApi* | [**GetContext**](docs/ContextApi.md#getcontext) | **GET** /blockchain/easy/0.9.1/{context} | Create a new context
